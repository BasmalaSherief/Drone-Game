...
graph TD
    ...
    subgraph "Terminal Window 1 (Input UI)"
        KB["Keyboard Manager<br/>Inputs & Telemetry Display"]
    end

    subgraph "Background Process"
        DC["Drone Controller<br/>Physics Engine & Repulsion"]
    end

    subgraph "Terminal Window 2 (Map UI)"
        BB["Blackboard Server<br/>Game State, Logic, Map Display"]
    end

    %% Define Pipes (Edges)
    KB -->|"fifoKD<br/>(Arrows/WASD forces, Commands)"| DC
    DC -->|"fifoDBB<br/>(Drone Position/Velocity state)"| BB
    BB -->|"fifoBBD<br/>(Active Obstacles Array)"| DC
    BB -->|"fifoBBDIS<br/>(Full World State)"| KB
